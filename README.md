...
2. Запустить команду php artisan migrate или php artisan migrate:refresh 
3. Запустить команду php artisan db:seed

Вход на странице Login переделан на поля Login и Password (ранее были поля Email и Password)
